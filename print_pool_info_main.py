...
from uniswap_v2_pool_singleton import create_pool_singelton
...
def _events_info(events, usdc_token_index, eth_token_index) -> Iterable[EventData]:
    for event in events:
